...
node_labels = {}  # e.g., {node_id: "Label", ...}
edge_labels = []  # e.g., [(start_node, end_node, "Relationship"), ...]
...
for _, row in data.iterrows():
    ...
    start_label = row['~start_node_labels']  # Adjust column name as needed
    end_label = row['~end_node_labels']      # Adjust column name as needed
